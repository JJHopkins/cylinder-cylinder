...
#ls = [2.0e-9,20.0e-9,200.0e-9,2000.0e-9]
...
np.savetxt('srw_lens.txt',G_l_t_dt)
...
pl.savefig('plots/compare/srw_lens_A0_A2.pdf')
show()
...
#show()
pl.savefig('plots/compare/srw_lens_G_vs_theta.pdf')
show()
