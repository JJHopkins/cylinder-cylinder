...
def ys(a,time,L, N):
	...
	term4 = (-2.0 * L * coeff * N * np.sqrt(time*time + 1.0)/(2.99e8))#*100))#NOTE: divided by 100 here
...
def y_2s(a,time, L, N): 
	...
	term2 = (-2.0*L*coeff*N*np.sqrt(time*time + 1.0)/(2.99e8))#*100)) #NOTE: divided by 100 here
...
def As(eizz,L,N,Y): 
	...
	term2 = 1.0 * (coeff*N)**4 * L**4 / ((2.99e8)**(4)) #NOTE: took out 1/c^4 for both A's
	term3 = Y
...
def A_2s(eizz, L , N ,Y):		
	term0 = (1.0/32)*kb*T
	term1 = ((eizz-1.0)/1.0)*((eizz-1.0)/1.0)
	term2 = 1.0 * (coeff*N)**4 * L**4 * (2.99e8)**(-4)
	term3 = Y
...
ts = np.arange(1e-27,10000000000e-27,dt)
...
G01 = -(EL[0]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[0] + sum_A_2[0]*np.cos(2.0*1.0/8*np.pi))/(2.0*np.sin(1.0/8*np.pi))
G11 = -(EL[1]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[1] + sum_A_2[1]*np.cos(2.0*1.0/8*np.pi))/(2.0*np.sin(1.0/8*np.pi))
G21 = -(EL[2]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[2] + sum_A_2[2]*np.cos(2.0*1.0/8*np.pi))/(2.0*np.sin(1.0/8*np.pi))
G31 = -(EL[3]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[3] + sum_A_2[3]*np.cos(2.0*1.0/8*np.pi))/(2.0*np.sin(1.0/8*np.pi))
G41 = -(EL[4]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[4] + sum_A_2[4]*np.cos(2.0*1.0/8*np.pi))/(2.0*np.sin(1.0/8*np.pi))
G51 = -(EL[5]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[5] + sum_A_2[5]*np.cos(2.0*1.0/8*np.pi))/(2.0*np.sin(1.0/8*np.pi))
G61 = -(EL[6]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[6] + sum_A_2[6]*np.cos(2.0*1.0/8*np.pi))/(2.0*np.sin(1.0/8*np.pi))
G71 = -(EL[7]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[7] + sum_A_2[7]*np.cos(2.0*1.0/8*np.pi))/(2.0*np.sin(1.0/8*np.pi))
G81 = -(EL[8]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[8] + sum_A_2[8]*np.cos(2.0*1.0/8*np.pi))/(2.0*np.sin(1.0/8*np.pi))
G91 = -(EL[9]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[9] + sum_A_2[9]*np.cos(2.0*1.0/8*np.pi))/(2.0*np.sin(1.0/8*np.pi))

G02 = -(EL[0]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[0] + sum_A_2[0]*np.cos(2.0*2.0*np.pi/8))/(2.0*np.sin(2.0*np.pi/8))
G12 = -(EL[1]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[1] + sum_A_2[1]*np.cos(2.0*2.0*np.pi/8))/(2.0*np.sin(2.0*np.pi/8))
G22 = -(EL[2]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[2] + sum_A_2[2]*np.cos(2.0*2.0*np.pi/8))/(2.0*np.sin(2.0*np.pi/8))
G32 = -(EL[3]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[3] + sum_A_2[3]*np.cos(2.0*2.0*np.pi/8))/(2.0*np.sin(2.0*np.pi/8))
G42 = -(EL[4]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[4] + sum_A_2[4]*np.cos(2.0*2.0*np.pi/8))/(2.0*np.sin(2.0*np.pi/8))
G52 = -(EL[5]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[5] + sum_A_2[5]*np.cos(2.0*2.0*np.pi/8))/(2.0*np.sin(2.0*np.pi/8))
G62 = -(EL[6]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[6] + sum_A_2[6]*np.cos(2.0*2.0*np.pi/8))/(2.0*np.sin(2.0*np.pi/8))
G72 = -(EL[7]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[7] + sum_A_2[7]*np.cos(2.0*2.0*np.pi/8))/(2.0*np.sin(2.0*np.pi/8))
G82 = -(EL[8]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[8] + sum_A_2[8]*np.cos(2.0*2.0*np.pi/8))/(2.0*np.sin(2.0*np.pi/8))
G92 = -(EL[9]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[9] + sum_A_2[9]*np.cos(2.0*2.0*np.pi/8))/(2.0*np.sin(2.0*np.pi/8))

G0 = -(EL[0]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[0] + sum_A_2[0]*np.cos(2.0*3.0*np.pi/16))/(2.0*np.sin(3.0*np.pi/8))
G1 = -(EL[1]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[1] + sum_A_2[1]*np.cos(2.0*3.0*np.pi/16))/(2.0*np.sin(3.0*np.pi/8))
G2 = -(EL[2]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[2] + sum_A_2[2]*np.cos(2.0*3.0*np.pi/16))/(2.0*np.sin(3.0*np.pi/8))
G3 = -(EL[3]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[3] + sum_A_2[3]*np.cos(2.0*3.0*np.pi/16))/(2.0*np.sin(3.0*np.pi/8))
G4 = -(EL[4]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[4] + sum_A_2[4]*np.cos(2.0*3.0*np.pi/16))/(2.0*np.sin(3.0*np.pi/8))
G5 = -(EL[5]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[5] + sum_A_2[5]*np.cos(2.0*3.0*np.pi/16))/(2.0*np.sin(3.0*np.pi/8))
G6 = -(EL[6]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[6] + sum_A_2[6]*np.cos(2.0*3.0*np.pi/16))/(2.0*np.sin(3.0*np.pi/8))
G7 = -(EL[7]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[7] + sum_A_2[7]*np.cos(2.0*3.0*np.pi/16))/(2.0*np.sin(3.0*np.pi/8))
G8 = -(EL[8]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[8] + sum_A_2[8]*np.cos(2.0*3.0*np.pi/16))/(2.0*np.sin(3.0*np.pi/8))
G9 = -(EL[9]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[9] + sum_A_2[9]*np.cos(2.0*3.0*np.pi/16))/(2.0*np.sin(3.0*np.pi/8))
...
print Gs 
pl.figure()
pl.plot(ls,Gs1, label = r'$\theta = \frac{\pi}{8}$')
pl.plot(ls,Gs2, label = r'$\theta = \frac{2\pi}{8}$')
pl.plot(ls,Gs , label = r'$\theta = \frac{3\pi}{8}$')
pl.legend()
