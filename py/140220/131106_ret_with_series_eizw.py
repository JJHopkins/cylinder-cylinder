...
G0 = -(EL[0]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[0] + sum_A_2[0]*np.cos(2.0*3.0*np.pi/8))/(2.0*np.sin(3.0*np.pi/8))
G1 = -(EL[1]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[1] + sum_A_2[1]*np.cos(2.0*3.0*np.pi/8))/(2.0*np.sin(3.0*np.pi/8))
G2 = -(EL[2]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[2] + sum_A_2[2]*np.cos(2.0*3.0*np.pi/8))/(2.0*np.sin(3.0*np.pi/8))
G3 = -(EL[3]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[3] + sum_A_2[3]*np.cos(2.0*3.0*np.pi/8))/(2.0*np.sin(3.0*np.pi/8))
G4 = -(EL[4]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[4] + sum_A_2[4]*np.cos(2.0*3.0*np.pi/8))/(2.0*np.sin(3.0*np.pi/8))
G5 = -(EL[5]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[5] + sum_A_2[5]*np.cos(2.0*3.0*np.pi/8))/(2.0*np.sin(3.0*np.pi/8))
G6 = -(EL[6]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[6] + sum_A_2[6]*np.cos(2.0*3.0*np.pi/8))/(2.0*np.sin(3.0*np.pi/8))
G7 = -(EL[7]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[7] + sum_A_2[7]*np.cos(2.0*3.0*np.pi/8))/(2.0*np.sin(3.0*np.pi/8))
G8 = -(EL[8]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[8] + sum_A_2[8]*np.cos(2.0*3.0*np.pi/8))/(2.0*np.sin(3.0*np.pi/8))
G9 = -(EL[9]*np.pi*r_1*r_1*r_2*r_2)*(sum_A[9] + sum_A_2[9]*np.cos(2.0*3.0*np.pi/8))/(2.0*np.sin(3.0*np.pi/8))
