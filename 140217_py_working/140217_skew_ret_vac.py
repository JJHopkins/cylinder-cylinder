...
pp = PdfPages('plots/skew_ret_vacuum/skew_ret_vacuum.pdf')
...
pl.savefig('plots/skew_ret_vacuum/eiz.pdf' )
pl.show()
show()
...
pl.title(r'$\mathrm{Hamaker \, coeff.s \,:\,skewed,\,retarded,\,vacuum}$', size = 20)
pl.legend(loc = 'lower right')
pl.axis([1e-9,1e-8,1e-24,1e-18])
pl.savefig('plots/skew_ret_vacuum/A0_A2.pdf')
show()
...
pl.title(r'$\mathrm{-G(\ell,\theta)\,vs.\,angle:\,skewed,\,retarded,\,vacuum}$', size = 20)
#pl.legend(loc = 'best')
pl.savefig('plots/skew_ret_vacuum/G_vs_theta.pdf')
show()
...
pl.title(r'$\mathrm{-G(\ell,\theta)\,vs.\,angle:\,skewed,\,retarded,\,vacuum}$', size = 20)
#pl.legend(loc = 'best')
pl.savefig('plots/skew_ret_vacuum/semilog_G_vs_theta.pdf')
show()
...
#pl.legend(loc = 'best')
pl.savefig('plots/skew_ret_vacuum/G_vs_l.pdf')
show()
...
pl.title(r'$\mathrm{-Log(G),\,retarded,\,skewed\,cyls\,in\,vacuum}$', size = 20)#uas a function of separation and angle')
cbar = pl.colorbar(CS, shrink = 0.8, extend = 'both')
cbar.ax.set_ylabel(r'$-Log(G(\mathcal{\ell},\theta))\,\,[k_{B}T]$', size = 14)
cbar.add_lines(CS)
##pl.axis([0,1.0,0,1.0])
#pl.grid()
pl.savefig('plots/skew_ret_vacuum/logG_contour.pdf')
show()
